...
export class Completed {
  ...
  constructor() {
    this.container = document.getElementById("completedContainer");
  ...
  public displayTasks(): void {
    ...
    if (completedTasks.length === 0) {
      this.container.innerHTML = Completed.EMPTY_HTML;
                                        ...
                                        <div class="p-3 w-100 task-card ring">
                                            <div class="d-flex justify-content-between align-items-center top-part">
                                                <div
                                                    ...
                                                    <div class="state-spot state-spot-completed"></div>
                                                </div>
                                            ...
                                            <h3 class="title-part mb-2 completed-title">${task.title}</h3>
                                            ...
                                            <div class="d-flex align-items-center gap-2 mb-3">
                                                ...
                                                <span
                                                    class="d-flex justify-content-center align-items-center lable-done"><i
                                                        class="fa-solid fa-check"></i>Done</span>
                                            </div>
                                            ...
                                            <div class="d-flex  align-items-center gap-2">
                                                ...
                                                <button class="btn start-btn" data-id="${task.id}"><i
